...
-   Looking at the map above, it's possible to use the estimated numbers of children in 2026 as an example.
    ...
    -   Even if just 50% of children from the area including Whitehawk pick and get offered DS
        (it will probably be more due to FSM proportions being high there). That’s 73
        children just in yr 7 who live West of Queens Park, who would be forced to travel
        to Longhill. And that’s a conservative estimate.
