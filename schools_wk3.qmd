...
-   How can spatial interaction be used to better inform an alternative to the current catchments? Do we even need catchments or can we come up with a much better solution which incorporates distance and socio-demographic diversity AT THE SAME TIME? What would such a system look like?
...
![A Stain On Our City?](data/stain.png){width="75%"}
