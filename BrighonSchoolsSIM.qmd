...
OptionC_1 <- st_read(here("data", "BTN_catchments","Catchment vectorised" ,"catchment_03.geojson"))
...
optionX_agg <- brighton_sec_schools_sml %>%
...
yr7_2024_optionX <- yr7_admissions %>% 
