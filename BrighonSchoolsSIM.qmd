...
tm_shape(BrightonLSOA_pw_cent) +
  tm_dots(size = "2024", col = "2024", alpha = 0.5, border.alpha = 0) +
  tm_layout(legend.show = TRUE, title = "11 year olds, 2024") +
tm_shape(bh_catchments) +
  tm_borders() +
  tm_fill(alpha = 0, col = "catchment")
...
nrow(brighton_lsoa_points_r51) * nrow(bh_sec_sch)
...
lsoa_btn_to_school_matrix <- 
  matrix(0, nrow = nrow(brighton_lsoa_points_r5_1), ncol = nrow(bh_sec_sch), dimnames = list(brighton_lsoa_points_r5_1$lsoa21cd,bh_sec_sch$id))
