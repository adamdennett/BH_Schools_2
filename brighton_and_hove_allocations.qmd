...
4.  **Whitehawk catchment removal — from a future admission round.** Removes a ward from Longhill's nominal catchment directly.
...
-   **The 2025 and 2026 Longhill Y7 actuals are the first two ticks of the new policy stack.** Longhill's Y7 offer count fell from **97 in 2025** to **81 in 2026**, a 16-pupil drop in one admissions round. That drop is consistent with the FSM priority (first year 2025) and Open Allocation (first year 2026) each having begun to pull several pupils per year across into central-catchment schools from the Longhill catchment. We cannot attribute the 2025-to-2026 step to the reforms with certainty from the public data — cohort-size change and random variation both contribute — but the direction and order of magnitude match what the policies were designed to do.
-   **2027 onwards is when the stack matures.** Sibling-linked OA admissions begin, the Whitehawk boundary change takes effect, and the Oct-25 council census shows smaller primary-catchment year groups working their way up the system. Each of these individually nudges Longhill's Y7 count downward; together they arrive in a compressed three-year window.
...
4.  **Removing Whitehawk may reduce the catchment's own retained intake.** Whitehawk has the lowest rates of private-sector take-up in the catchment (deprivation correlates strongly with state-sector uptake), the lowest rates of car ownership (which restricts the choice set to schools reachable on foot or by bus), and is further from Cardinal Newman, Kings and Priory than Woodingdean or Saltdean are. On any reasonable prior, Whitehawk was the part of the Longhill catchment most likely to have *already been* sending its children to Longhill pre-2025 — the FSM priority introduced in 2025 will have given its most deprived families a new route out to a central-catchment school ahead of that, but for non-FSM Whitehawk families it is still a short walk or bus ride to Longhill and a much longer journey anywhere else. The direct mechanical effect of removing Whitehawk is to **strip out exactly the part of the catchment that was propping up Longhill's numbers**, leaving a residual catchment that is more affluent on paper but has a longer track record of *not* choosing Longhill — and which will soon have OA and sibling priority as additional formal exits. The 2025 figure of 97 offers and the 2026 figure of 81 offers are the post-leakage numbers *with* Whitehawk still in the catchment and *before* sibling compounding has begun; numbers for the first intake *without* Whitehawk, and *with* the OA sibling uplift biting, plausibly land lower, not higher.
5.  **The policy stack is cumulative, and the tailwind runs against Longhill.** FSM out-of-catchment priority first bites in 2025; Open Allocation in 2026; OA-sibling priority in 2027; the Whitehawk change sits alongside them. Each is individually modest. Stacked, they all subtract from the same number — the count of Longhill-catchment children who end up at Longhill High — and they all compound over admission rounds rather than resetting each year. The 2025→2026 Longhill Y7 drop (97→81) is the first two rounds of this sequence showing in the data; 2027 onwards brings the remaining two layers in together. Any benefit from the Whitehawk change alone would have to swim against that tide.
