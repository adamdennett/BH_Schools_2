...
function(el, x) {
  ...
  function setLegend(year, nOver, nUnder) {
    if (!legDiv) return;
    legDiv.innerHTML =
      '<strong>1st-pref apps &minus; PAN &mdash; ' + year + '</strong><br>' +
...
### The Whitehawk change doesn't sit in isolation: three concurrent policy levers pulling in the same direction

The Whitehawk boundary change is only the most visible of a stack of **2024 admissions policy changes** that all operate on the same flow — peripheral-catchment pupils into central-catchment schools. Before evaluating the Whitehawk hypothesis, it matters that the council has, deliberately and recently, built *three other* mechanisms that already push in the direction the Whitehawk argument worries about. All four now run concurrently:

1.  **Open Allocation priority (introduced 2024).** Five per cent of the Year 7 places at each of Varndean, Dorothy Stringer, Hove Park and Blatchington Mill — the four "central" catchment schools — are now reserved for applicants resident in the four **single-school catchments** on the edge of the city (BACA, PACA, Patcham, Longhill). On combined central-catchment PANs of roughly 1,170, that is around **58 Open Allocation places per year**, shared across four peripheral origins. Longhill's notional share is in the order of 14 places a year — but the allocation is oversubscription-driven and will redistribute to whichever peripheral catchments actually apply.
2.  **Out-of-catchment sibling priority (introduced alongside Open Allocation).** Once an Open Allocation pupil has been admitted, a younger sibling applying in a later year gets priority over in-catchment non-sibling applicants. In the usual B&H admissions arithmetic, siblings account for something like 25 % of incoming Y7 offers. As the Open Allocation cohort matures and starts producing younger siblings entering Y7, the effective peripheral-to-central share stops being "5 % of places" and drifts upward — plausibly towards **close to 10 % in steady state** once a few cohorts have passed through.
3.  **Out-of-catchment Free School Meals priority (pre-existing in 2024).** FSM-eligible children living outside a school's catchment already sit above in-catchment non-FSM applicants in the oversubscription criteria for most B&H secondaries. This is a much older policy than Open Allocation, and it has always given pupils in deprived parts of peripheral catchments — Whitehawk conspicuously included — a formal route into central-catchment schools.
4.  **The Whitehawk boundary change itself (from 2026/27 admissions).** Removes a ward from Longhill's catchment directly.

These four mechanisms do not add up independently — OA, sibling and FSM priorities can stack on the same individual applicant — but their *directional* effect is unambiguous: they systematically lift the share of central-catchment places going to peripheral-catchment children, and they systematically reduce the in-catchment retention denominator for Longhill, BACA, PACA and Patcham.

The 2024 FOI numbers are broadly consistent with this stack being active. Longhill catchment sent **12 pupils to Dorothy Stringer, 8 to Hove Park, plus small numbers to Blatchington Mill and Varndean** — roughly **25–30 offers**, or **10 %** of the catchment's total offers. That is the same order of magnitude as the combined Open Allocation + FSM + sibling ceiling above. Much of what looks like generic "leakage" from Longhill into the central catchment is very likely the council's own admissions policies working as designed. It will continue — and under the sibling compounding effect, will probably grow over the next few admission rounds — regardless of any Whitehawk decision.

This reframes two of the points in the next section. Point 3 below ("the next-biggest leakage is geographic") needs qualifying: some of the BACA / Dorothy Stringer / Hove Park flow is *policy-driven* (OA / FSM / sibling) rather than proximity-driven, and the two explanations are impossible to separate with the public data. And point 4 needs strengthening: the residual non-Whitehawk Longhill catchment will not only inherit a longer track record of not choosing Longhill, it will also have formal mechanisms pulling it into central catchment schools that weren't there a decade ago.
...
3.  **The next-biggest leakage is part-geographic, part-policy — and neither part is helped by the boundary change.** The **38 Longhill-catchment offers to Priory School in Lewes** in 2024 almost certainly come from Saltdean families, for whom Priory is the closest secondary school by road, and is unaffected by any B&H policy at all. The flow into the central-catchment schools (Dorothy Stringer, Hove Park, Varndean, BMS) is a mix of proximity and of the council's own Open Allocation / FSM / sibling stack — neither of which is blunted by the Whitehawk change, and the second of which is *designed* to keep growing as siblings come through.
4.  **Removing Whitehawk may reduce the catchment's own retained intake.** Whitehawk has the lowest rates of private-sector take-up in the catchment (deprivation correlates strongly with state-sector uptake), the lowest rates of car ownership (which restricts the choice set to schools reachable on foot or by bus), and is further from Cardinal Newman, Kings and Priory than Woodingdean or Saltdean are. On any reasonable prior, Whitehawk is the part of the Longhill catchment most likely to have *already been* sending its children to Longhill — exactly the pattern the FSM priority was designed to disrupt for the most deprived families who wanted a central-catchment alternative, but which plainly left a residual Whitehawk intake at Longhill too. The direct mechanical effect of removing Whitehawk is to **strip out exactly the part of the catchment that was propping up Longhill's numbers**, leaving a residual catchment that is more affluent on paper but has a longer track record of *not* choosing Longhill — and which now has OA and sibling priority as additional formal exits. The 2025 figure of 97 offers and the 2026 figure of 81 offers are the post-leakage numbers *with* Whitehawk still in the catchment; the post-leakage numbers *without* Whitehawk, and *with* the OA sibling uplift maturing, plausibly land lower, not higher.
5.  **The policy stack is cumulative, and the tailwind runs against Longhill.** Open Allocation was introduced in 2024 and the sibling uplift compounds over successive years; FSM out-of-catchment priority was already operating; the Whitehawk change is 2026/27. Each is individually modest. Stacked, they all subtract from the same number — the count of Longhill-catchment children who end up at Longhill High — and they all compound over admission rounds rather than resetting each year. Any benefit from the Whitehawk change would have to swim against that tide.
