...
-   Longhill has the worst Progress 8 scores in the City in 2022/23, with BACA performing slightly better at that time, although with BACA improving and Longhill declining in 2024, the gap between these schools is increasing.
...
ggplot(england_school_2022_23_not_special, aes(y = P8MEA, x = PPERSABS10)) +
  ...
  labs(title = "Progress 8 vs Persistent Absence %, 2022-23",
       ...
       color = "Ofsted Rating") +
  theme_minimal() +
  annotate("text", x = Inf, y = Inf, label = paste("Intercept:", intercept, "\nSlope:", slope), hjust = 1.1, vjust = 2, size = 5, color = "black") +
  xlim(0, 100)
