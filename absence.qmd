...
ggplot(absence_secondary, aes(x = sess_unauthorised_percent, fill = factor(year))) +
  ...
  theme_minimal() +
  geom_vline(data = btn_absence_secondary, aes(xintercept = sess_unauthorised_percent), color = "black", linetype = "solid", linewidth = 1) +
  geom_vline(data = eng_absence_secondary, aes(xintercept = sess_unauthorised_percent), color = "red", linetype = "solid", linewidth = 1) +
  facet_wrap(~ year) +  # Facet by year
  labs(title = "Unauthorised Absence Rates for State-funded Secondary \nSchools by Year",
